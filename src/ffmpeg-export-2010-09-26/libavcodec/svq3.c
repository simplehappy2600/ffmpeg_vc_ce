...
#ifdef _MSC_VER
static const enum PixelFormat svq3_decoder_pix_fmts[] = {PIX_FMT_YUVJ420P, PIX_FMT_NONE};
AVCodec svq3_decoder = {
	...
	/*pix_fmts*/svq3_decoder_pix_fmts,
	/*long_name*/"Sorenson Vector Quantizer 3 / Sorenson Video 3 / SVQ3",
