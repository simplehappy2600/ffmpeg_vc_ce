...
#ifdef _MSC_VER
static const enum PixelFormat svq1_decoder_pix_fmts[] = {PIX_FMT_YUV410P, PIX_FMT_NONE};
AVCodec svq1_decoder = {
	...
	/*pix_fmts*/svq1_decoder_pix_fmts,
	/*long_name*/"Sorenson Vector Quantizer 1 / Sorenson Video 1 / SVQ1",
