...
SRC_PATH="/home/jiangyuanli/ffmpeg/ffmpeg-export-2010-09-26-win32"
SRC_PATH_BARE=/home/jiangyuanli/ffmpeg/ffmpeg-export-2010-09-26-win32
BUILD_ROOT="/home/jiangyuanli/ffmpeg/ffmpeg-export-2010-09-26-win32"
CC_IDENT=gcc 3.4.4 (cygming special, gdc 0.12, using dmd 0.125)
ARCH=x86
CC=gcc
AS=gcc
LD=gcc
...
CFLAGS=   -std=c99 -fno-common -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -O3 -fno-math-errno
ASFLAGS=   -g
CC_O=-o $@
...
SHFLAGS=-shared -Wl,--enable-auto-image-base -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
...
EXTRALIBS= -lavicap32 -lm -lz -lpsapi 
INSTALL=install
LIBTARGET=
...
libavutil_VERSION=50.28.0
libavutil_VERSION_MAJOR=50
libavfilter_VERSION=1.45.0
